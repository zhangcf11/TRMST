...
#' @export
#' @references Chengfeng Zhang,Baoyi Huang,Hongji Wu,Hao Yuan,Yawen Hou*,Zheng Chen*.Restricted mean survival time regression model with time-dependent covariates.Statistics in Medicine.2022;41(21):4081–4090.
#' @examples
#' library(TRMST)
#' data(heartdata)
